---
title: "Liu XC-6 sampls-RNAseq-R vs F"
...
countdata <- countdata[,c("R2","R3","R4","F2","F3","F4")]
head(countdata)
```
...
ann_colors = list(
  ...
  Replicate = c(Rep1 = "darkred", Rep2 = "forestgreen",Rep3 = "darkblue")
)
...
vol +   
  ...
  xlab(expression(log[2]("R" / "F"))) + # Change X-Axis label
...
for (genegroup in c("total","upregulated","downregulated")) {
  ...
  print(barplot(go_enrich, 
          drop = TRUE, 
          showCategory = 15, 
          title = paste("GO Biological Pathways using",genegroup,"Genes",sep = " "),
          font.size = 8))
  
  write.csv(go_enrich,file = paste("GO-Biological-Pathways-using",genegroup,"Genes.csv",sep = "-"))
}
