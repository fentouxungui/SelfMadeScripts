  ...
  dashboardBody(
    tabItems(
      ...
      tabItem(tabName = "dashboard",
              fluidRow(
                tabBox(title = "Results", width = 7,height = "500px",
                  tabPanel(title = "Feature Plot",plotOutput("FeaturePlot"))),
                tabBox(title = "Settings", width = 5,height = "500px",
                  tabPanel(
                    title = "Feature Plot",
                    selectInput("dataset", "Choose a dataset:", 
                                choices = c("EC", "APC","Ttk-5d","Ttk-14d-rep1","Ttk-14d-rep2")),
                    helpText(""),
              ...
              fluidRow( 
                tabBox( title = "Additional Info",height = "800px",
                  tabPanel(
                    title = "Cluster Info",
                    plotOutput("ClusterInfo")),
                  tabPanel(
                    title = "RNA Velocity",
                    plotOutput("RNAVelocity"))
                  ),
                tabBox(
                  tabPanel(
