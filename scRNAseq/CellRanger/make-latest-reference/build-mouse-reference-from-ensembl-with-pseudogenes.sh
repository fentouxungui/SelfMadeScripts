...
# Genome metadata
genome="mm10-202310-WithPseudogenes"
version="Ensembl-Release110-GeneCode-vM33"

# Set up source and build directories
build="mm10-202310-WithPseudogenes_build"
mkdir -p "$build"
...
IG_V_pseudogene|IG_J_pseudogene|IG_C_pseudogene|IG_pseudogene|\
processed_pseudogene|unprocessed_pseudogene|unitary_pseudogene|transcribed_processed_pseudogene|\
