...
```{r}
Results.dir <- "./5.1-Rds/scVI-Method"
...
```{r}
rds.file <- list.files("./5.1-Rds",full.names = TRUE,pattern = "rds$")
...
saveRDS(immune.combined, file = paste(Results.dir,"/",sampleName,sep = ""))
```

# save embedings and annotatons to orign rds file

```{r}
# immune.combined <- readRDS(paste(Results.dir,"/",sampleName,sep = ""))
