...
prepare.data <- function(selected_rows = NULL,
  ...
  #pr[pr==0] = 1 # why not 0.01
  pr[pr==0] = ifelse (min(pr) < 0.01,min(pr),0.01) 
...
Para.selected[!Para.selected %in% Pairs.seleted]
# Tumor specific LR-pairs
Tumor.selected[!Tumor.selected %in% Pairs.seleted]
