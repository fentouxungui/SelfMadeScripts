...
```{r}
cellchat.LI <- readRDS("./4.5-Ligand-Receptor-Analysis/CellChat/Subset-LI/Embryo-D145-LI-CellChat.rds")
cellchat.SI <- readRDS("./4.5-Ligand-Receptor-Analysis/CellChat/Subset-SI/Embryo-D145-SI-CellChat.rds")
Results.dir <- "./4.5-Ligand-Receptor-Analysis/CellChat/SI-vs-LI"
...
for (i in levels(cellchat@idents$joint)) {
  print(netAnalysis_signalingChanges_scatter(cellchat, idents.use = i))
}
```
...
```{r}
system(paste0("mkdir -p ",Results.dir))
saveRDS(cellchat, file = paste0(Results.dir,"/","cellchat_comparisonAnalysis_Mouse_Large_Intestine_vs_Small_Intestine.rds"))
sessionInfo()
```
