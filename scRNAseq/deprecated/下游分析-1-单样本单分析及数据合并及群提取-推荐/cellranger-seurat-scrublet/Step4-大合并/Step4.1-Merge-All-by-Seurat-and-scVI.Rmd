...
colnames(immune.combined@meta.data)[grepl("^RNA_snn_res",colnames(immune.combined@meta.data))] <- 
  paste("Merged_Harmony_",colnames(immune.combined@meta.data)[grepl("^RNA_snn_res",colnames(immune.combined@meta.data))],sep = "")
```
...
DimPlot(immune.combined,group.by = "day",reduction = "scviumap")
DimPlot(immune.combined,reduction = "scvitsne",group.by = "day")
```
...
DimPlot(immune.combined,label = TRUE,split.by = "day",ncol = 4,reduction = "scviumap")
```
...
```{r}
colnames(immune.combined@meta.data)[grepl("^RNA_snn_res",colnames(immune.combined@meta.data))] <- 
  paste("Merged_SCVI_",colnames(immune.combined@meta.data)[grepl("^RNA_snn_res",colnames(immune.combined@meta.data))],sep = "")
```
