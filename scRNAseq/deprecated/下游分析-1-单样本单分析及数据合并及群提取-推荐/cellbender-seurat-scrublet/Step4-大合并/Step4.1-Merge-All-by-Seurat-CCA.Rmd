---
title: "Step 4.1 Merge all samples by Seurat CCA"
...
```{r}
Results.dir <- "./4.1-Merged-Rds/CCA-Method"
```
...
```{r}
immune.anchors <- FindIntegrationAnchors(object.list = obj.list, dims = 1:30, anchor.features = 4000)
...
# g2m.genes
g2m.genes
immune.combined <- CellCycleScoring(immune.combined, s.features = s.genes, g2m.features = g2m.genes, set.ident = TRUE, assay = "CellBender")
```
