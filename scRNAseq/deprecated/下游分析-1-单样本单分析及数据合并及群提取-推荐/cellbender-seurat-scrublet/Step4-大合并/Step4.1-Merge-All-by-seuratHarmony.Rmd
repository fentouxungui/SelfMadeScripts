...
immune.combined@meta.data$orig.ident <- factor(immune.combined@meta.data$orig.ident, 
                                               levels = c("E_LI_D115_B1", "E_LI_D115_B2", "E_LI_D125_B1", "E_LI_D125_B2", "E_LI_D135_B1", "E_LI_D145_B1", "E_LI_D145_B2", "E_LI_D155_B1",
                                                           "E_LI_D195_B1", "P_LI_D1_B1", "P_LI_D1_B2", "P_LI_D7_B1", "P_LI_D21_B1", "P_LI_D21_B2"
                                                          #"P_LI_DAdult_B1"
                                                          ))
immune.combined@meta.data$day <- factor(immune.combined@meta.data$day,levels = c("E_D115", "E_D125", "E_D135", "E_D145", "E_D155", "E_D195", "P_D1","P_D7","P_D21"
                                                                                 # "P_DAdult"
                                                                                 ))
```
