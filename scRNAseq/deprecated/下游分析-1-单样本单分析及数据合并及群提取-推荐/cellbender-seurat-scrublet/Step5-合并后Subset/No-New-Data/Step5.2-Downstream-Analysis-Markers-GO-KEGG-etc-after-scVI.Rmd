---
title: "Step5.2 Downstream Analysis"
...
cluster.resolution <- paste("scvi_", DefaultAssay(cds),"_snn_res.0.6",sep = "")
...
for (i in levels(cds@active.ident)) {
  ...
  markers.subset$entrez <- mapIds(x = get(org.db),
                     ...
                     multiVals = "first")
  # GO
  GO.dir <-  paste(save.dir,"/GO-scVI",sep = "")
  ...
  # KEGG
  KEGG.dir <-paste(save.dir,"/KEGG-scVI",sep = "")
