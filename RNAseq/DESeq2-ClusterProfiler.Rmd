...
countdata <- countdata[,c("Young_FeEE_3","Young_FeEE_2","Young_FeEE_1","M_EE_3","M_EE_2","M_EE_1")]
```
...
metadata <- data.frame(row.names = colnames(countdata),
                       ...
                       Replicate = c(paste("Rep",3:1,sep = ""),paste("Rep",3:1,sep="")),
...
if (FALSE) {
  ...
  write.table(t(c("oDAM-Pros-peaks", # make sure using same type gene ids(ENSEMBL or ENTREZID) !
