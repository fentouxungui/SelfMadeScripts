...
reads_min_length=20
paired=false
hisat2_index=/data0/reference/hisat2_index/D.melanogaster.BDGP6.Genome/bdgp6/genome
...
genes_gtf=/data0/reference/STAR_index/Drosophlia/BDGP6_ensembl/genes.gtf
...
cd ${output_path} && mkdir -p ./6_Counts_RSEM && cd ./6_Counts_RSEM && RSEM_path=`pwd`
cd $star_mapping_path
